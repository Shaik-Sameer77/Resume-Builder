...
const AuthButtonWithProvider = ({Icon, label,provider}) => {
  ...
  return (
    <div onClick={handleClick} className='w-full px-4 py-3 rounded-md border-2 border-blue-700 flex items-center justify-between cursor-pointer group hover:bg-blue-700 active:scale-95 duration-150 hover:shadow '><Icon className="text-txtPrimary text-xl group-hover:text-white"/>
